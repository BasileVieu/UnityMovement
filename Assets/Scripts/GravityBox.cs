...
public class GravityBox : GravitySource
{
    ...
    void OnValidate()
    {
        boundaryDistance = Vector3.Max(boundaryDistance, Vector3.one);
    ...
    float GetGravityComponent(float _coordinate, float _distance)
    {
    ...
    public override Vector3 GetGravity(Vector3 _position)
    {
        ...
        if (distances.x < distances.y)
        {
            ...
            {
                vector.z = GetGravityComponent(_position.x, distances.z);
            }
        }
    ...
    void DrawGizmosRect(Vector3 _a, Vector3 _b, Vector3 _c, Vector3 _d)
    {
    ...
    void DrawGizmosOuterCube(float _distance)
    {
        Vector3 a;
        Vector3 b;
        Vector3 c;
