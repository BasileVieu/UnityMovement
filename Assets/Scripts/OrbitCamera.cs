...
public class OrbitCamera : MonoBehaviour
{
    ...
    [SerializeField] [Range(1.0f, 20.0f)] private float focusDistance = 5.0f;
    ...
    [SerializeField] [Range(-89.0f, 89.0f)] private float minVerticalAngle = -45.0f;
    [SerializeField] [Range(-89.0f, 89.0f)] private float maxVerticalAngle = 45.0f;
    ...
    void LateUpdate()
    {
        ...
        Vector3 lookPosition = focusPoint - lookDirection * focusDistance;
    ...
    void UpdateGravityAlignment()
    {
        ...
        gravityAlignment = angle <= maxAngle ? newAlignment : Quaternion.SlerpUnclamped(gravityAlignment, newAlignment, maxAngle / angle);
    }
    ...
    static float GetAngle(Vector2 _direction)
    {
